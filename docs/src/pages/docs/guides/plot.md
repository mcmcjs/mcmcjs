...
`trace`, `density`, `histogram`, `rank`, `autocorr`, `pair`, `scatter`, `energy`, `forest`, `ecdf`, `cumulative-mean`, `running-rhat`, `violin`, `chain-intervals`, `chain-intervals-all`, `summary-table`, `diagnostics-heatmap`, `splom`, `parallel-coords`, `corner`, `ppc-density`, `ppc-stat`, `loo-pit`.
